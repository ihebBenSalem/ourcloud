<link rel="stylesheet" type="text/css" href="/src/mdl/material.css">
...
$sql = " SELECT * FROM `upload_file` WHERE `ext`='mp4' or `ext`='avi' or `ext`='3gp' and `user_id`='$id_sess'    ";
...
'.$row['name'].'</td>
                    ...
                    <td class="mdl-data-table__cell--non-numeric"><a href="/cloud/controller/download.php?id='.$row['file_id'].'" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Download</a></td>
